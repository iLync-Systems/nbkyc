...
import 'dart:async';
import 'dart:io';
import 'package:nb_kyc/registerMaps.dart';

const colorA = const Color(0XFF272A8B);

class RegisterUUB extends StatelessWidget{
  @override
...
class RegisterUB extends StatefulWidget{
  @override
  MyRegisterUB createState() => new MyRegisterUB();
}
class MyRegisterUB extends State<RegisterUB> {
  File _image;
