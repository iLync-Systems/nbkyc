...
import 'dart:async';
import 'dart:io';
import 'package:nb_kyc/registerUtility.dart';

const colorA = const Color(0XFF272A8B);

class RegisterIID extends StatelessWidget{
  @override
...
class RegisterID extends StatefulWidget{
  ...
  RegisterID(String fn, String sn, String pn, String ad){
    this.fname = fn;
    this.sname = sn;
    this.phone = pn;
    this.address = ad;
  ...
  @override
  MyRegisterID createState() => new MyRegisterID(fname,sname,phone,address);
}
class MyRegisterID extends State<RegisterID> {
  String fname;
  String sname;
  var phone;
  String address;

  MyRegisterID(this.fname,this.sname,this.phone,this.address);
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: RawMaterialButton(
                                ...
                                onPressed: (){
                                  print(fname+" "+sname+" "+phone+" "+address+"Hello");
                                  Navigator.push(context, new MaterialPageRoute(
                                      builder: (context) => RegisterUUB()
                                  ));
                                },
                              ),
                            ),
